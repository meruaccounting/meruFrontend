...
// const SplitActivity = ({ date, open, act, handleClose, startTime, endTime, project }) => {
...
//     let endValue = `${new Date(year, month, day, endhrs, endmins, 0, 0).getTime()}`;
...
//                 defaultValue={timeC(startTime, commonData.commonData.user?.accountInfo?.timeZone)}
//                 variant="filled"
...
//                 hiddenLabel
//                 id="filled-hidden-label-small"
//                 defaultValue={timeC(endTime, commonData.commonData.user?.accountInfo?.timeZone)}
...
//           >
//             <span>
//               <Checkbox color="success" onChange={(e) => setDeleteActivity(e.target.checked)} />
...
//               Split Activity
//             </Button>
//             <Button variant="outlined" color="primary" onClick={handleSplitClose}>
//               Cancel
//             </Button>
//           </Box>
//         </Box>
